(function ($) {
    ...
    const i18n = {
        en: {
            ...
            'about.feature1_title': 'Coverage Across The Island',
                'about.founded': 'Founded in Mağusa, we operate between Mağusa and Turkey, providing fast and reliable logistics services.',
        ...
        tr: {
            ...
            'about.feature1_title': 'Ada çapında Kapsama',
                'about.founded': 'Şirketimiz Mağusa\'da kurulmuştur ve Mağusa ile Türkiye arasında faaliyet göstermektedir.',
            'about.feature1_text': 'Stet stet justo dolor sed duo. Ut clita sea sit ipsum diam lorem diam justo.',
    ...
    i18n.en['contact.paragraph'] = 'Reach the right person directly — phone numbers and emails listed below.';
    i18n.tr['contact.paragraph'] = 'Doğrudan doğruya ilgili kişiyi ulaşın — telefon numaraları, e-posta adresleri aşağıda listelenmiştir.';
    i18n.en['contact.team_title'] = 'Our Team';
    i18n.tr['contact.team_title'] = 'Ekibimiz';
    i18n.en['feature.title1'] = 'We Are Trusted Logistics Company';
    i18n.tr['feature.title1'] = 'Güvenilir Lojistik Şirketiyiz';
    i18n.en['feature.title2'] = 'Services between Turkey and TRNC';
    i18n.tr['feature.title2'] = 'Türkiye-KKTC arası seferler';
    i18n.en['feature.title3'] = 'On Time Delivery';
    i18n.tr['feature.title3'] = 'Zamanında Teslimat';
    i18n.en['feature.title4'] = '7/24 Telephone Support';
    i18n.tr['feature.title4'] = '7/24 Telefon Desteği';
